...
IP2LocObj.open("data\\IP-COUNTRY-SAMPLE.BIN") # Windows path separator. Must change to '/' for Unix like platform
...
IP2LocObjIPv6.open("data\\IPV6-COUNTRY.BIN") # Windows path separator. Must change to '/' for Unix like platform
